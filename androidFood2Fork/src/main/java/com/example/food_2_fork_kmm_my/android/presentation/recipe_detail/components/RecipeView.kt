package com.example.food_2_fork_kmm_my.android.presentation.recipe_detail.components
...
fun RecipeView(
    ...
    LazyColumn(
        ...
        // этот айтем позволяет описать детали рецепта - если их много то его можно скроллить
        item {
            RecipeImage(
